...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn1Web, but1Calendar, btn1Map, btn2Web, btn2Calendar, btn2Map, btn3Web, btn3Calendar, btn3Map;
    ...
    private void setupButtonClickEvents() {
        ...
        btn1Map.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("geo:46.8160558,-92.1061221"));
                if (intent.resolveActivity(getPackageManager()) != null) {
                    startActivity(intent);
                }
            }
        ...
        btn2Map.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("geo:46.8163602,-92.1064748"));
                if (intent.resolveActivity(getPackageManager()) != null) {
                    startActivity(intent);
                }
            }
